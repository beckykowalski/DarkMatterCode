...
def Fitter(datafile):
    ...
    ROOT.gSystem.RedirectOutput(datafile+"_fitter.log")
    outfile = open(datafile+"_fitResult.txt", "w")
...
#    outfile.write("\n")
    ...
    outfile.write(SmC.Print())
#    outfile.write("\n")

    outfile.write(S0.Print())
#    outfile.write("\n")

    outfile.write(T.Print())
#    outfile.write("\n")

    outfile.write(frame.chiSquare())
#    outfile.write("\n")
...
#    Fitter("DC50_Sm10_phi0_T365")
#    Fitter("DC50_Sm5_phi0_T365")
#    Fitter("DC30_Sm10_phi0_T365")
#    Fitter("DC50_Sm10_phi91.25_T365")
    Fitter("DC50_Sm10_phi0_T182.5")
