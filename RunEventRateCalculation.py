...
def CalculateEventRate(sig0, Mchi, ElementList, Estart, Estop, NumberEnergies):
    ...
    E, R, Sm, S0, FF, xList = HaloModelEventRate(k0, rho, Mchi, sig0, ElementList, v0, vEsc, vEavg, Estart, Estop, NumberEnergies)
    ...
    b.set_ylim([0.99,1.1])
    f.tight_layout()
    f.savefig("ModulatingRate_June19_100GeV_0to300keV.png")
